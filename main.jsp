...
<div class="main_list">
  ...
  <!--   <div>
        <button id="carousel-prev-btn">&#9664;</button>
        <button id="carousel-next-btn">&#9654;</button>
    </div>
...
// 책 캐러셀, showBooks(), moveCarousel() 등은 기존 유지
</script>

<!-- 기존 booksData, showBooks, moveCarousel 함수 포함된 <script>는 그대로 이어붙이면 됩니다 -->
