 ...
 * Generated at: 2025-07-11 05:39:47 UTC
...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <title>로그인 - 책 추천 웹사이트</title>\n");
      out.write("    ");
      out.write("\n");
      out.write("<!DOCTYPE html>\n");
      out.write("<style>\n");
      ...
      out.write("        .input-group input[type=\"radio\"] + label { /* 라디오 버튼 라벨 스타일 조정 */\n");
      ...
      out.write("        }\n");
      out.write("        \n");
      out.write("        .input-group.gender-group { /* 성별 그룹 스타일 */\n");
      out.write("            display: flex;\n");
      out.write("            align-items: center;\n");
      ...
      out.write("            width: auto; /* 라디오 버튼 너비 조정 */\n");
      out.write("        }\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("            try {\n");
      out.write("                const response = await fetch('api/auth/login', { // 상대 경로로 변경\n");
      out.write("                    method: 'POST',\n");
      out.write("                    headers: {\n");
      out.write("                        'Content-Type': 'application/json'\n");
      out.write("                    },\n");
      out.write("                    body: JSON.stringify({ username: username, password: password })\n");
      out.write("                });\n");
      out.write("\n");
      out.write("                const apiResponse = await response.json();\n");
      out.write("\n");
      out.write("                if (apiResponse.status === 'success') {\n");
      out.write("                    alert(apiResponse.message);\n");
      out.write("                    window.location.href = 'main.jsp'; // 메인 페이지 URL\n");
      out.write("                } else {\n");
      out.write("                    errorMessageDiv.textContent = apiResponse.message || '로그인에 실패했습니다.';\n");
      out.write("                }\n");
      out.write("            } catch (error) {\n");
      out.write("                console.error('로그인 요청 중 오류 발생:', error);\n");
