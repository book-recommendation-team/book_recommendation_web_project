<%-- mypage.jsp (수정된 최종 버전) --%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="model.User"%>
<%
// 1. 페이지 맨 위에서 변수를 한 번만 선언합니다.
User loggedInUser = (User) session.getAttribute("loggedInUser");
String contextPath = request.getContextPath();

// [중요] 만약 로그인하지 않은 사용자가 이 페이지에 접근하면 로그인 페이지로 보냅니다.
...
<body>
	<%-- [수정] 모든 페이지에서 동일한 헤더를 사용하도록 include로 변경합니다. --%>
	...
	<div class="main-content-wrapper">
		<div class="sidebar">
			<div class="profile">
				<img src="${pageContext.request.contextPath}/img/사진.jpg" alt="프로필사진"
					class="image">
				<%
			...
			<div class="main-container">
				...
				<div id="edit-profile-detail-content" class="content-section">
					...
					<form id="edit-profile-detail-form">
						...
						<%-- 새 비밀번호 입력 필드 추가 --%>
						<label for="detail-new-password">새 비밀번호:</label> <input
							type="password" id="detail-new-password"
