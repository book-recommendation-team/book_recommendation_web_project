...
public class DBUtil {
    ...
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/book_recommendation_db?serverTimezone=UTC&useSSL=false";
    private static final String USER = "root";
    private static final String PASSWORD = "tlagustjr!23"; // 여러분의 실제 비밀번호
