...
<body>
	...
	<div class="container">
		...
		<form id="celebForm" enctype="multipart/form-data"> <%-- action, method 제거, id 추가 --%>
			<label>이름</label> <input type="text" name="celebName" required>
			<label>설명</label><input
				type="text" name="celebDescription" required>
			...
			<div class="button-box">
				<button type="submit" class="submit-btn">작성하기</button> <%-- type="submit" 유지 --%>
				<button type="button" class="cancel-btn" onclick="history.back()">취소</button>
			</div>
		</form>
        <div id="response-message"></div> <%-- 성공 메시지 표시 영역 --%>
