			...
			<div class="books-section">
				...
				<div class="featured-book">
					...
					<c:url var="featuredBookUrl" value="/bookClick">
						...
						<c:param name="link"
							value="https://search.shopping.naver.com/book/catalog/32461159846" />
					</c:url>
		...
		<div class="cards-section">
			...
			<div class="grid">
				...
				<c:url var="clickUrl_2" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/32441695777" />
				</c:url>
				...
				<c:url var="clickUrl_3" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/40542385623" />
				</c:url>
				...
				<c:url var="clickUrl_4" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/46881757624" />
				</c:url>
				...
				<c:url var="clickUrl_5" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/47690626624" />
				</c:url>
				...
				<c:url var="clickUrl_6" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/32470073992" />
				</c:url>
				...
				<c:url var="clickUrl_7" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/45695882618" />
				</c:url>
				...
				<c:url var="clickUrl_8" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/32470068305" />
				</c:url>
				...
				<c:url var="clickUrl_9" value="/bookClick">
					...
					<c:param name="link"
						value="https://shopping.naver.com/book/catalog/41235476621" />
				</c:url>
				...
				<c:url var="clickUrl_10" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/32483162283" />
				</c:url>
				...
				<c:url var="clickUrl_11" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/46241088621" />
				</c:url>
				...
				<c:url var="clickUrl_12" value="/bookClick">
					...
					<c:param name="link"
						value="https://search.shopping.naver.com/book/catalog/39561655618" />
				</c:url>
